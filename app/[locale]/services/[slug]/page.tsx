    ...
    <>
            ...
            <div className="lg:col-span-7 space-y-10">
              ...
              <div>
                <h2 className="font-display font-bold text-brand-dark text-2xl mb-5">
                  {dict.serviceDetail.pourquoiChoisir}
                </h2>
              ...
              <div>
                <h2 className="font-display font-bold text-brand-dark text-2xl mb-6">
                  {dict.serviceDetail.notreProcessus}
                </h2>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        {dict.serviceDetail.whatsappReponseRapide}
                      </a>
                      <Link
                        href="/contact"
                      ...
                      >
                        {dict.serviceDetail.demanderRappel}
                      </Link>
                    </div>

                    <p className="font-body text-[11px] text-text-muted text-center mt-3">
                      {dict.serviceDetail.consultationGratuite}
                    </p>
                  </div>
                </div>
              </div>
      ...
      {related.length > 0 && (
        <section className="bg-brand-cream py-14">
          <Container>
            <h2 className="font-display font-bold text-brand-dark text-2xl mb-8">
              {dict.serviceDetail.autresServices}
            </h2>
